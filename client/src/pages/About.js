      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Meet the Experts Behind MINA
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our dedicated team of healthcare professionals, engineers, and AI specialists 
              are committed to transforming the healthcare experience.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="mt-4 text-base text-gray-500">
                  Board-certified physician with over 15 years of experience in telemedicine 
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img
                className="w-full h-64 object-cover"
                src="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                alt="Team member"
              />
              <div className="p-6">
                ...
                <p className="mt-4 text-base text-gray-500">
                  AI and machine learning expert with a passion for applying cutting-edge 
                  technology to solve healthcare challenges.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-primary">Head of User Experience</p>
                <p className="mt-4 text-base text-gray-500">
                  Specializes in creating intuitive, accessible digital healthcare experiences 
